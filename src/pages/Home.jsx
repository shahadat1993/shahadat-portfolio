    ...
    <div className="overflow-hidden">
      ...
      <section className="container-px mx-auto max-w-7xl min-h-[85vh] grid md:grid-cols-2 gap-10 items-center relative">
        ...
        <div>
          ...
          >
            Hi, I'm{" "}
            <span className="accent-grad-text">{profile.firstName}</span>.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="container-px mx-auto max-w-7xl py-24 grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mt-3">
            I like clean architecture and honest feedback loops.
          </h2>
          <p
          ...
          <div className="grid grid-cols-3 gap-3 mt-8">
            {profile.stats.map((s) => (
              <div key={s.label} className="surface rounded-xl p-4 text-center">
                ...
                <p className="font-display font-semibold mt-1 text-sm">
                  {s.value}
                </p>
              </div>
            ))}
          ...
          <Link
            to="/about"
            data-cursor-hover
            className="inline-flex items-center gap-2 accent-text font-medium mt-8"
          >
      ...
      <section className="container-px mx-auto max-w-7xl py-24">
        <SectionHeading
          ...
          subtitle="Explore recent work showcasing full-stack architecture and creative solutions."
          align="center"
        />
        ...
        <section className="container-px mx-auto max-w-7xl py-10">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-display text-xl md:text-2xl font-bold mt-1">
                  Looking for my next big opportunity
                </p>
                <p
            ...
            <Link
              to="/contact"
              data-cursor-hover
              className="accent-bg text-white px-6 py-3 rounded-full font-medium flex items-center gap-2 shrink-0"
            >
      ...
      <section className="container-px mx-auto max-w-7xl py-24">
        <div className="flex items-end justify-between">
          ...
          <Link
            to="/blog"
            data-cursor-hover
            className="hidden md:flex items-center gap-1 text-sm accent-text mb-10"
          >
